...
fn should_parse_bill_and_extract_bill_id() {
    let result = parse_bill_amendments("119-21", "tests/test_data/bills/119-hr-1.xml");
...
fn should_extract_amendments_from_bill() {
    let data = parse_bill_amendments("119-21", "tests/test_data/bills/119-hr-1.xml").unwrap();
...
fn should_produce_same_result_from_str_and_file() {
    // Load XML manually
    let xml_str = std::fs::read_to_string("tests/test_data/bills/119-hr-1.xml")
    ...
    // Parse from file
    let from_file_result = parse_bill_amendments("119-21", "tests/test_data/bills/119-hr-1.xml");
...
fn should_generate_deterministic_amendment_id() {
    ...
    let data2 = parse_bill_amendments("119-21", "tests/test_data/bills/119-hr-1.xml").unwrap();
